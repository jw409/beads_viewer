...
var (
	// Base colors - using AdaptiveColor for light/dark terminal support
	...
	ColorBgHighlight = lipgloss.AdaptiveColor{Light: "#DDDDDD", Dark: "#44475A"}
	ColorText        = lipgloss.AdaptiveColor{Light: "#1A1A1A", Dark: "#F8F8F2"}
	ColorSubtext     = lipgloss.AdaptiveColor{Light: "#444444", Dark: "#BFBFBF"}
	ColorMuted       = lipgloss.AdaptiveColor{Light: "#666666", Dark: "#6272A4"}

	// Primary accent colors - high contrast for both modes
	...
	// Status background colors (for badges) - lighter for light mode
	...
	// Priority background colors - lighter for light mode
	ColorPrioCriticalBg = lipgloss.AdaptiveColor{Light: "#F8D7DA", Dark: "#3D1A1A"}
	ColorPrioHighBg     = lipgloss.AdaptiveColor{Light: "#FFF3CD", Dark: "#3D2A1A"}
	ColorPrioMediumBg   = lipgloss.AdaptiveColor{Light: "#FFFDE7", Dark: "#3D3D1A"}
